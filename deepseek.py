...
CURRENCY_SYNONYMS: dict[str, tuple[str, ...]] = {
    ...
    "EUR": ("eur", "€", "евро"),
    "RUB": ("rub", "₽", "российск", "руб рф", "рублей рф"),
    "CNY": ("cny", "rmb", "юан", "юани", "юаней", "юаня", "китайск"),
    "THB": ("thb", "бат", "бата", "батов", "баты", "тайск"),
...
3. Валюту приводи к коду ISO: рубль/руб/бр = BYN, доллар/$/бакс = USD, евро/€ = EUR,
   российский рубль/₽ = RUB, юань/RMB = CNY, тайский бат/THB = THB, злотый = PLN,
   гривна = UAH, тенге = KZT, фунт = GBP.
